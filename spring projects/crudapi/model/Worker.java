...
public class Worker implements Comparable<Worker> {
    ...
    public Worker(int workerID, String firstName, String lastName, int salary, String dept, String email) {
        this.workerId = workerID;
        this.firstName = firstName;
    ...
    public Worker(int workerID, String firstName, String lastName, int d, Date joiningDate, String dept, String email) {
        this.workerId = workerID;
        this.firstName = firstName;
        this.lastName = lastName;
        this.salary = d;
