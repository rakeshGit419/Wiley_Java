...
public class WorkerController {
	...
	public String create(@RequestBody Worker worker) {
		//Worker worker = new Worker(Integer.parseInt(paramMap.get("worker_id")),paramMap.get("firstName"),paramMap.get("lastName"),Integer.parseInt(paramMap.get("salary")),paramMap.get("joiningDate"),paramMap.get("department"),paramMap.get("email"));
