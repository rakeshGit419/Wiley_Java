...
public class BankClass {
    public static void main(String[] args) {
        ...
        // -----------------------------------------------------------------------------------------------------
        GeneralAccount gAcc = new GeneralAccount(100,"Rakesh");
        gAcc.getStatement();  // Today's Task

        SavingsAccount sAcc = new SavingsAccount(103,"prem");
        sAcc.getStatement();

        CurrentAccount cAcc = new CurrentAccount(104,"charani");
        cAcc.getStatement();
     // -----------------------------------------------------------------------------------------------------
